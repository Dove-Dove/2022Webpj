                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <button class="btn btn-default" data-oper="modify2"><a href="/board/modify2?bno=${board.bno}">Modify</a></button>
                           <button class="btn btn-info" data-oper="list2"><a href="/board/list2">List</a></button>                             												
